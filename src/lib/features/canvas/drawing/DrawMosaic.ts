...
import { MosaicElement } from "@/lib/type/editor/canvasElements";
...
export const drawMosaicElement = (
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    drawMosaic(point.x, point.y, element.size, element.degreeOfBlur, context);
  }
};
